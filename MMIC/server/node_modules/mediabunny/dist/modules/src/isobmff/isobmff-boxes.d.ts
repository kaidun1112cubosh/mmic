...
export declare const edts: (trackData: IsobmffTrackData) => Box;
...
export declare const btrt: (trackData: IsobmffTrackData) => Box | null;
...
export declare const tfra: (trackData: IsobmffTrackData) => Box;
/**

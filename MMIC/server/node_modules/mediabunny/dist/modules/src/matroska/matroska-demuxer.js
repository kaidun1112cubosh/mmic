 ...
 */
import { extractAv1CodecInfoFromPacket, extractDtsFourCcFromPacket, extractAvcDecoderConfigurationRecord, extractHevcDecoderConfigurationRecord, extractProresCodecInfoFromPacket, extractVp9CodecInfoFromPacket, } from '../codec-data.js';
import { extractAudioCodecString, extractColorSpace, extractVideoCodecString, OPUS_SAMPLE_RATE, PRORES_FOURCCS, } from '../codec.js';
import { Demuxer } from '../demuxer.js';
import { Logging } from '../logging.js';
import { AttachedFile, DEFAULT_TRACK_DISPOSITION } from '../metadata.js';
import { assert, binarySearchLessOrEqual, COLOR_PRIMARIES_MAP_INVERSE, colorSpaceIsComplete, EMPTY_COLOR_SPACE, findLastIndex, isIso639Dash2LanguageCode, isThenable, last, MATRIX_COEFFICIENTS_MAP_INVERSE, centeredTransformationMatrix, DEG_TO_RAD, multiplyMatrices, normalizeRotation, rotationMatrix, roundIfAlmostInteger, scaleMatrix, textDecoder, toDataView, TRANSFER_CHARACTERISTICS_MAP_INVERSE, UNDETERMINED_LANGUAGE, } from '../misc.js';
